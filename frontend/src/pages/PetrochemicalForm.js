        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-group">
                    <label>How Satisfied are you with the Quality of Petrochemical Products?</label>
                ...
                <div className="form-group">
                    <label>How Satisfied are you with the Availability of Petrochemical Products?</label>
                ...
                <div className="form-group">
                    <label>How Satisfied are you with the Pricing of Petrochemical Products?</label>
